...
| 애니메이션, 쉬운 로그인, 외부 API 지도, 포스트, 프런트엔드 백엔드 | 채팅 기능, 채팅 목록, 데이터베이스, 백엔드 프런트엔드 | 회원 정보 관리, 게시판 기능, 관심 설정, 프런트엔드 백엔드 | 채팅 기능, 채팅 룸, 데이터베이스, 백엔드 프런트엔드 | CCTV 기능 구현, 백엔드 프런트엔드 | 로그인 / 회원 가입, 백엔드 프런트엔드 |
